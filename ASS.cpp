...
void draw(void)
{
	...
	name(-100,-80,string3,0,0,1);
	name(-100,-70,string4,0,1,1);
	name(5,95,string5,1,1,1);
	name(95,5,string6,1,1,1);

	display(10,10,40,30,1,0,0);
	display(10,30,50,90,1,0,0);
	display(-10,30,-20,60,0,0,1);
	display(-10,10,-50,20,0,0,1);
	display(-20,-10,-35,-20,0,1,0);
	display(-10,-40,-30,-70,0,1,0);
	display(10,-10,25,-55,0,1,1);
	display(35,-25,55,-30,0,1,1);
